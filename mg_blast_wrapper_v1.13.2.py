...
#Writing logfile
        ...
        log_header = ['Run','Project Name','Created', 'Reference(s)','No. Ref. Sequences','Metagenome','No. Metagenome Contigs' , alen_header, "Min iden (%)", shear_header,'No. Recruited Contigs', "Mean Contig Size (bp)","STD Contig Size", "SEM Contig Size", "Mean Contig alen (bp)","STD Contig alen", "SEM Contig alen", "Mean Contig iden (bp)","STD Contig iden", "SEM Contig iden", "Mean Contig GC (%)","STD Contig GC","SEM Contig GC","Mean Reference GC (%)","STD Reference GC","SEM Reference GC"]
        ...
        log_row = [run,name.split("/")[0],time_str, ";".join(ref_lst),ref_cnt, metagenome,len(all_records[i]) , alen, iden, shear_log_value,len(ids), sizes_avg,sizes_avg_std, sizes_avg_sem, alen_avg,alen_avg_std, alen_avg_sem, iden_avg,iden_avg_std, iden_avg_sem, gc_avg,gc_avg_std, gc_avg_sem,ref_gc_avg,ref_gc_avg_std, ref_gc_avg_sem]    
