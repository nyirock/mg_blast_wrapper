...
# Transforming data
    ...
    #cutoff_contigs[dataframe]=evalue_filter(cutoff_contigs[dataframe])
        ...
        recruited_mg[i] = recruited_mg[i][['quid', 'suid', 'iden', 'alen','Coverage','Metric', 'mism', 'gapo', 'qsta', 'qend', 'ssta', 'send', 'eval', 'bits','Ref_size','Ref_GC','Contig_size','Contig_GC','Contig_nt']]
